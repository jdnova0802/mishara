...
Industry pick: `hunt/INDUSTRY_LOCK.md`. Not Nisaba. One company, two products, same kind of lock. City: dispatch/detain, three offices. Military product is being made **imposing**: lock in the gear, not a share-tab. Act options in `INDUSTRY_LOCK.md`. Saw-it / boss still. Pipes / clearing **off**.
