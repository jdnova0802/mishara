...
Industry pick: `hunt/INDUSTRY_LOCK.md`. Not Nisaba. **One company, two products, same kind of lock (the form).** City product locked (people coordinating, dispatch/detain, three offices). Military product = different program, same lock, acts not named. Regular people are not customers. Pipes / clearing **off**.
