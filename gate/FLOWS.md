# Acts and flows — what prints, what is still a hole
...
## Already seated (code + a price, or a formula)

| Rent | On | Status | Door |
|------|----|--------|------|
| **$0.10/hop** | Each irreversible hop | Seated · $0 until Gate 1 | `/operator` |
| **10 bps** (+5 above $500M/mo) | Cleared flow | Seated · they weld first | `/operator` |
| **$5,000/mo floor** | `max(floor, bps, hop)` | Seated · they weld first | `/operator` |
