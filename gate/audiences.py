...
PLATES: dict[str, dict] = {
    "developers": {
        ...
        "subhead": "Lab fuse hop for drills. Fail closed + verify URL. Production is a weld — not Free/Pro.",
        ...
        "proof": "Hop demo on homepage · openapi.json",
    ...
    "agents": {
        ...
        "subhead": "Hop before commit. Fail closed if clearance fails. Soft prompt policy is not clearance. MCP-ready.",
    ...
    "operators": {
        "emoji": "💸",
        "title": "Operators",
        "headline": "Weld one path. Clear before wire.",
        "subhead": "Clearance on irreversible spend. Weld one path. 10 bps of what clears. Licensed payout or bind-only. Management monthly per path.",
        "pain": "Calculators and agent installs do not sit on payout or bind. Narrative without a halt is not infrastructure.",
        "offer": "One production write fail-closed in 48hr. Extra write = another weld. Licensed only.",
        "price": "Fee schedule · 10 bps of cleared flow",
        "cta_label": "Fee schedule",
        "cta_route": "register_page",
        "secondary_label": "Weld a path",
        "secondary_route": "operator_page",
        "proof": "Fail-closed hop on their write. Independent verify. No PII.",
    ...
    "carriers": {
        ...
        "subhead": "Same hop family as PAS bind-check. Clearance before irreversible commit.",
    ...
    "enterprise": {
        ...
        "subhead": "Prepaid fuse tree. Fail closed when parent is revoked. Not a seat grid.",
    ...
    "boards": {
        ...
        "subhead": "No AI literacy required. Clearance states with independent verify. Click verify.",
    ...
    "defense": {
        ...
        "secondary_href": f"{VELARU_PUBLIC}/check",
        "proof": "Fail-closed clearance · independent verify",
...
def opportunities_manifest(public_url: str, contact_email: str) -> dict:
    ...
    return {
        ...
        "gatekeep": "Audience doors point at weld and fee schedule. Lab is footnote. Not seats.",
    }
