...
PLATES: dict[str, dict] = {
    "developers": {
        ...
        "subhead": "Lab fuse hop for drills. DEAD → verdict:false + verify URL. Production is a weld — not Free/Pro.",
        "pain": "You're building agent loops without a kill switch that strangers can verify.",
        "offer": "Lab hop docs · public demo · production = operator weld",
        "price": "Lab drills · weld for production",
        "cta_label": "Mouth economics",
        "cta_route": "pricing",
        "secondary_label": "Lab docs",
    ...
    "agents": {
        ...
        "headline": "Pre-exec mouth for autonomous agents",
        "subhead": "Hop before commit. Fail closed on DEAD. Soft prompt policy ≠ DENY. MCP-ready.",
    ...
    "startups": {
        ...
        "subhead": "We wire one pre-exec fuse. You demo DEAD fail-closed. Not a Pro seat — a lab path. Production = weld.",
        "pain": "You need proof of control before the board meeting — not another sprint of infra.",
        "offer": "One agent path wired + handoff call · production weld separate",
        "price": "One-time wiring",
        "cta_label": "Book agent wiring",
        "cta_route": "install",
        "secondary_label": "Mouth economics",
    ...
    "enterprise": {
        ...
        "subhead": "Prepaid fuse tree. DEAD propagates fail-closed. Not a seat grid.",
    ...
    "investors": {
        ...
        "offer": "Live metrics · register · status",
        "price": "Register on cleared flow",
        "cta_label": "View status",
        "cta_route": "status_page",
        "secondary_label": "The register",
    ...
    "partners": {
        ...
        "offer": "Partner wiring · rev share on welded mouths",
        "price": "Per wiring + register share",
...
def opportunities_manifest(public_url: str, contact_email: str) -> dict:
    ...
    return {
        ...
        "gatekeep": "Audience doors point at weld/register. Lab is footnote. Not SaaS.",
    }
