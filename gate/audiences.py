...
PLATES: dict[str, dict] = {
    ...
    "defense": {
        ...
        "subhead": "Independent verify. their_production false until welded. Signed restraint receipts — not resurrection from UI.",
        "pain": "Delegated autonomy without public existence proof fails closed.",
        "offer": "Clearance weld inquiry · SCITT/AIR export path · assessment",
        "price": "Custom",
        "cta_label": "Defense inquiry",
        "cta_mailto": "subject=Defense%20%E2%80%94%20Clearance%20weld",
        "secondary_label": "Trust & limits",
        "secondary_route": "trust",
        "proof": "Fail-closed clearance · independent verify · parent→child halt",
