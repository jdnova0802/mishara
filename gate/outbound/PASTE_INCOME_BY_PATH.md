# PASTE — Potential income by Gate path (26 Sep 2026)

**Rule:** Unit price from live SKUs / code. Near = if demand closes. Ceiling = if the path works at scale. **Booked revenue tonight = $0** on every path unless a Stripe session already settled.

Bands are **arithmetic / offer cards**, not forecasts.

---

## Cash SKUs (can print this month)

| Path | Unit | Near (if 1–few close) | Ceiling | Notes |
|------|------|------------------------|---------|-------|
| **Diligence — free REVIEW** | **$0** | **$0** (funnel only) | $0 | Monday 10 emails. Converts → deposit / Bind Room / weld. |
| **Diligence — deposit** | **$2,500** | **$2.5k–$25k** (1–10 deposits) | Low alone | Live checkout. Upsell into review band. |
| **Diligence — review** | **$5k–$8k** | **$5k–$40k** (1–5 reviews) | Mid | After deposit / REVIEW prove-out. |
| **Diligence — retainer** | **$10k–$40k/mo** | **$10k–$80k/mo** (1–2 desks) | **$120k–$480k/yr** per desk | Highest near cash *if* a desk stays. Hard close. |
| **Bind Room** | **$1,750** | **$1.75k–$7k** (1–4) | **~$84k/yr** at cap | Cap **4/mo** hands. Fastest Stripe dollar. |
| **Install** | **$2,500** | Same class as deposit | Parallel SKU | Wiring framing; not faster than Bind Room. |
| **Refusal** | **$7,500** | **$0–$7.5k** rare | Event | Birth cert of a non-entity. Low volume. |
| **Operator weld** | **$25,000** + **$5k/mo** floor | **$30k first 30d** (1 weld) | See flow table | One irreversible write. Licensed only. |
| **Extra welded write** | **+$25k** + **+$5k/mo** | Stacks | Stacks | One write per weld. |
| **Pro hops** | **$99/mo** | Noise | Ignore | De-emphasized vs weld. |

### Diligence funnel math (Monday 10)

| Conversion | Cash |
|------------|------|
| 0 REVIEW replies | $0 |
| 1–2 REVIEWs → 0 deposit | $0 (labor spent) |
| 1 deposit | **$2,500** |
| 1 deposit → 1 review | **~$7.5k–$10.5k** total |
| 1 retainer at mid band | **+$25k/mo** ongoing |

Honest base case for cold 10: **$0–$2.5k** in 2–4 weeks. Upside case: **one retainer** changes the year.

### Operator weld — register (code `operator_invoice`)

**One quiet weld (1 mouth, no parents):**

| Cleared / mo through mouth | Gate register / mo |
|----------------------------|--------------------|
| Quiet / floor only | **$5,000** |
| $100M | **~$105k** ($5k mgmt + 10 bps) |
| $1B | **~$1.255M** |
| $10B | **~$14.8M** (+ carry above $500M) |

**Illustrative scale (100 mouths + 500 LIVE parents):** mgmt alone **~$3M/mo**; flow stacks on top. That is **formula**, not a booked book.

---

## Rail / mouth paths (meter ≠ SKU tonight)

| Path | How Gate would earn | Near | Ceiling | Blocker |
|------|---------------------|------|---------|---------|
| **Clear / Seal / Go / Never** (core) | Sold only via Bind Room / weld / diligence | $0 alone | Embedded in cash SKUs | Doctrine, not a checkout |
...
## Ranked by *near* cash (honest)

1. **Bind Room $1,750** — fastest cleared dollar if anyone pays  
2. **Diligence deposit $2,500** → review → **retainer $10–40k/mo** — Monday’s actual bet  
