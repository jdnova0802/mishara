# Extreme odds — Gate 1 → padlock

**Willingness is not the scarce thing. Sequence is.**  
Do this order. Skip Absolute inventing. Skip MGA ghosts. Skip Forbes anxiety.

**Still:** `$0` until stranger paid + proved.  
Padlock liquid/NW ($0.5–2B by ~22, higher later) **requires** Gate 1 → meter → Conformant Schelling → ownership mark/sale. There is no skip.

---

## Tier A — make Gate 1 odds *extreme* (do these)

### A1. Money path unbreakable (48h max once deploy starts)

| Done? | Item |
|-------|------|
| ☐ | Live URL serves `/bind-room` with real Stripe ($1,750) |
| ☐ | Test charge (or $1 test) → webhook fires → you get notified |
| ☐ | Persistent disk (`MAX.md`) — paid order + keys survive restart |
| ☐ | Secure cookies on HTTPS |
| ☐ | `/ops/orders` shows the payer without SSH |
| ☐ | Stranger can open prove / officer pack without you on call |

**Rule:** If checkout or prove is soft, **do not** send sales emails yet. Fix first.

### A2. One throat, one sentence (memorize)
...
No H₀. No coffin. No $100B. No Conformant franchise pitch from Bind.

### A3. Pond (only these)

| Do | Don’t |
|----|--------|
| AI deployers facing E&O / renewal | Ghosted MGA list |
| Specialty brokers → ask intro to *insured* | Cold “AI governance” LinkedIn spray |
| Builders with irreversible tool-use | Defense / C2 |
| Warm humans who already opened a plate | Everyone on the opportunities map |
| Counsel quote batch (Tue) **in parallel** — does not replace Bind | Waiting for counsel before any Bind ask |

### A4. Cadence that creates extreme odds
...
**Volume rule:** ≤15 thoughtful outreaches > 200 spray. Personalize one line (their product / renewal / broker book).

### A5. Parallel warm force-multipliers (do ≥2)
...
## Tier B — after Gate 1 (padlock becomes *possible*)

Gate 1 ≠ padlock. It unlocks the ladder.

| Week after Gate 1 | Move |
|-------------------|------|
| Immediate | S03 meter on · floor + bps language live · stop inventing |
| 2–4 | One weld or second Bind · Conformant draft as franchise ask |
| 1–3 mo | Design-partner for redeem rail or insurability folio API |
| Ongoing | Collect 3–5 logos / prove cases → strategic narrative |
| When meter + logos exist | Talk to fat buyers / secondary — not before |

**Padlock ($0.5–2B NW/liquid class by end-22)** needs:

1. Gate 1 ✓  
2. Meter + Conformant foothold ✓  
3. Rail seat starting (interchange / redeem / insurability) ✓  
4. **Ownership × buyer who believes Schelling** ✓  

H₀/R₀/coffin = **story and ceiling**, not the invoice.

---

## Tier C — what “willing to do anything” does *not* mean

| Temptation | Why it kills odds |
|------------|-------------------|
| More Absolute inventing | Dilutes Tuesday |
| Bumping MGAs again | Already dead pond |
| Pitching coffin/H₀ to Bind buyers | Confuses the $1,750 close |
| Waiting for perfect public forever | Extreme odds need a live ask |
| Building sixth plate / museum | Mouth Ceiling / zero cash |
| Fake traction / fake logos | Burns the only asset: prove |
| Illegal/grey “growth” | Not worth the throat |

---

## Extreme-odds scorecard (be honest weekly)

Give yourself 1 point each:

1. Live Stripe Bind works  
2. Prove works stranger-side  
3. Disk + webhook + ops orders  
4. 10 N1 emails sent  
5. All followed up once  
6. ≥1 warm intro or broker thread live  
7. ≥1 reply that isn’t “unsubscribe”  
8. Counsel batch sent (parallel)  
9. You can demo DEAD→verify in <2 minutes  
10. Calendar blocked daily for follow-ups (not inventing)

| Score | Odds read |
|-------|-----------|
| 0–3 | Low–moderate |
| 4–6 | High |
| **7–10** | **Extreme for Gate 1** |

Padlock scorecard starts **after** Gate 1; don’t confuse them.

---

## This week (if deploy is ready)

1. A1 green  
2. Ten N1 emails  
3. Two warm levers from A5  
4. Counsel quotes Tue (parallel)  
5. No new invention docs  
