...
FAMILY_BITES: dict[str, dict[str, Any]] = {
    ...
    "erra": {
        ...
        "live": True,
        "scores": {
            "problem_clarity": 9.5,  # EIOPA / reinsurance research pass
            "market_bite": 9.5,
            "voice": 7.5,  # doctrine + paste pack shipped; live site still pending paste
            "public_face": 7.5,
            "icp_focus": 8.5,
            "economics_model": 8.0,
            ...
            "irreplaceable": 8.0,
            "rail_speed": 7.5,
            "world_class_quality": 8.0,
            "shadow_integration": 9.0,
            "mother_nature": 8.5,
            "copy_pitch": 8.0,
        },
        "gaps_honest": [
            "Paste /family/erra hero into velaru.xyz/erra — doctrine ready, live chrome still twin",
    ...
    "verra": {
        ...
        "live": True,
        "scores": {
            "problem_clarity": 9.0,  # bind-only irreversibility researched
            "market_bite": 9.0,
            "voice": 7.0,  # paste pack ready; was weakest — lifted by research voice
            "public_face": 7.0,
            "icp_focus": 8.5,
            "economics_model": 7.5,
            "technical_differentiation": 8.0,
            "deployability": 7.0,
            "buyer_trust": 7.5,
            "narrative_vs_reality": 8.0,
            "competitive_positioning": 8.0,
            "antifragile": 7.5,
            "irreplaceable": 7.0,
            "rail_speed": 8.5,
            "world_class_quality": 7.5,
            "shadow_integration": 8.0,
            "mother_nature": 8.0,
            "copy_pitch": 7.5,
        },
        "gaps_honest": [
            "Paste /family/verra into live Verra — stop TOC voice on the site",
            "Ops queue after ALLOW remains production SOW",
        ],
    },
    "gate": {
        "name": "Gate",
    ...
    "mishara": {
        ...
        "scores": {
            "problem_clarity": 9.0,
            "market_bite": 9.0,
            "voice": 8.0,  # in-repo voice upgrade
            "public_face": 7.5,
            "icp_focus": 8.0,
            "economics_model": 4.0,
            ...
            "rail_speed": 7.0,
            "world_class_quality": 7.5,
            "shadow_integration": 7.0,
            "mother_nature": 9.0,
            "copy_pitch": 8.0,
        },
        "gaps_honest": [
            "Attorney referral still coming",
            "Consumer door — not Action OS cosplay; economics intentionally thin",
        ],
    },
}
...
def score(public_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "weakest_voice": {
            ...
            "fix": "Paste /family/{id} hero into live sibling — doctrine ready on Gate",
        },
