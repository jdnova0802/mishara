# Invisible Staple Scale — chicken · broccoli · rice of power

**Status:** doctrine catalog + manifest seed. **Not MGA outbound.**  
**Under coordinators. Never private Omega.**

> Loud cool is dessert.  
> Invisible cool is steak.  
> **Chicken broccoli rice** is what actually builds the body.  
> Gate aims to own the full diet of invisible power — from quiet sci-fi to paperwork that bores the dead.

This file invents the **scale**, not another L2 throat pack.  
Stop-rule still holds: no foothill widget spam until paid weld.  
Stack-rule: name the invisible diet before someone Foundrys peelable may.

---

## The scale (0 = cosmic bland staple · 10 = coolest still-invisible)

| Score | Name | Feel | Job |
|------:|------|------|-----|
| **10** | **Bone Law** | Quiet terror | May in the bones; extract ⇒ amputate |
| **9** | **Sheath Cell / May Fuse** | Hardware don’t-fuck-with-me | Physical mouth object on the write path |
| **8** | **Senate Socket** | Quorum as object | N-of-M LIVE seat in metal/protocol |
| **8** | **Consent Lattice** | Treaty room | Multi-flag LIVE mesh |
| **7** | **Stranger Black Box** | Flight-recorder energy | Prove-after anyone can open |
| **7** | **Deadman / Silence DENY** | SCRAM culture | Loss of contact ⇒ DENY |
| **6** | **Oath Compiler** | ROE → machine | Clauses become inhibit graph |
| **6** | **Restraint Clearing (ρ)** | Bloomberg of non-fire | Restraint settles as mass |
| **5** | **Principal Continuity** | Inheritance boredom with teeth | Death/substrate without stranger handoff ⇒ hooks die |
| **5** | **Mouth Registry** | Directory of throats | Attested serial · semver · funeral state |
| **4** | **Funeral Bit** | Decommission checkbox | Prove the mouth is dead |
| **4** | **Bind Genealogy** | Lineage stamp | Who cleared whom across hops |
| **3** | **Mass Number (μ)** | Ugly scalar | Undo-cost of the act as a unit |
| **3** | **May Window Clock** | Calendar tyranny | LIVE budget / sabbath / jubilee as schedule |
| **2** | **Who-Field** | Form field | No principal filled ⇒ no act |
| **2** | **When-Stamp** | Timestamp as law | Ordering is the fight |
| **1** | **Title Seat** | Officer title fill | Named human seat on the halt (SERFF-shaped) |
...
Without serial ⇒ ghost act (antimay-adjacent).  
*Cosmic endgame:* World-Write Census runs on Act Serials.

### CBR-0 — Refuse Line
A line item proving non-fire / non-bind / non-pay.  
Restraint Invoice’s boring twin.  
*Cosmic endgame:* Heat-Death Ledger and ancestor vaults are Refuse Lines at scale.

### CBR-1 — Verify Stub
The product is an ugly link a stranger opens.  
If your “control” has no stub, it’s a club log.  
*Cosmic endgame:* Ancestor Receipt Vault is Verify Stubs that outlive empires.

### CBR-1 — Title Seat
A human title must be named as halt owner — paperwork that examiners take.  
*Cosmic endgame:* Biosphere Quorum / guardian seats are Title Seats for non-human principals.

### CBR-2 — Who-Field
Principal slot empty ⇒ write impossible.  
Not “user experience.” Existence condition.  
*Cosmic endgame:* Xeno Principal Table is Who-Field under first contact.

### CBR-2 — When-Stamp
Time ordering as constitutive. Soft clocks forge LIVE.  
*Cosmic endgame:* Light-delay clearance and relativistic principal drift are When-Stamp under physics stress.

### CBR-3 — Mass Number (μ)
Undo-cost as a number desks share.  
Boring metrology; cosmic when scaled to Kardashev.  
*Cosmic endgame:* Kardashev Sheath is μ tiers I → II → III.

### CBR-3 — May Window Clock
May lives on a schedule: budgets, cool-offs, sabbaths, jubilees.  
*Cosmic endgame:* Jubilee Grid is civic Window Clock.

### Already named (placed on scale)
Bone Law (10) · Mandate pillars (5–6) · Oath / ρ / Funeral / Genealogy / Density / Foothill max objects (4–7) · forge hardware ambitions (8–9).
...
| Mistake | Fix |
|---------|-----|
| Only invent 8–10 (cool invisible) | You become aesthetic Forge Twitter |
| Only invent 0–2 (forms) | You become compliance PDF vendor |
