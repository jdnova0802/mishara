...
**Inventions still left that move ceilings (not unlockers):** Y1 missing-mouth PAS · Y2 missing-mouth Idira · **Y2b Agent 365 / Entra** · Y3 XF1/XF3 nationalize · Y4 specialty→capacity · D5 cloud default · S1 may interchange live enough to 15–30× · F15 de-risking · **Ω / Ρ / Ν** (category fatten — cut, burden, hold). Y1/Y2/Y2b/D5 are the first attach points of **Ν**. **Cross (`CROSS.md`) is the simultaneous latch** — same folio on Y1/Y2/Y2b **and** Y3, not a new raiser. **Release (`RELEASE.md`) is the liquid twin** — same missing-mouth on payout, not a new remaining book. **Φ/Α/Γ do not raise this table. They replace it. W₀ does not raise it either. W₀ makes the table a joke.** Full Sep→22+ blast map: `gate/BLAST.md`.
