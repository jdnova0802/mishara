...
Cloud already green (run to confirm):
  ...
  python3 -m gate.sims.prove_mouth_watch          # S9 defensive intel
  ...
  python3 -m gate.sims.prove_lab_invariant        # REQUIRED: their_production hard-false
...
Do:
- Local HTTP stranger-verify for receipts (GET by receipt_id)
...
Prove: bank-send-shaped DENY; stranger fetch receipt; prior proves OK.
