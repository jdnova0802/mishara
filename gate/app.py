...
def well_known_gate():
    ...
    payload: dict[str, Any] = {
        ...
        "version": "1.0.0",
        "public_face": public_face_mod.gate_public_face_block(pub),
        "catalog": public_face_mod.gate_catalog_block(pub),
        "openapi": f"{pub}/openapi.json",
        "signup": f"{pub}/signup",
        "install": f"{pub}/install",
        "bind_room": f"{pub}/bind-room",
        "operator": f"{pub}/operator",
        "register": f"{pub}/register",
        "register_manifest": f"{pub}/.well-known/register.json",
        "operator_invoice": f"{pub}/.well-known/operator.json",
        "bound": f"{pub}/bound",
        "only": f"{pub}/only",
        "floor": f"{pub}/floor",
        "this": f"{pub}/this",
        ...
        "inhabitant": f"{pub}/inhabitant",
        "afterward": f"{pub}/afterward",
        "bound_answer": f"{pub}/.well-known/bound-answer.json",
        "exclusive_timing": f"{pub}/.well-known/exclusive-timing.json",
        "stakes": f"{pub}/.well-known/floor.json",
        "particular": f"{pub}/.well-known/particular.json",
        "inhabitant_manifest": f"{pub}/.well-known/inhabitant.json",
        "afterward_manifest": f"{pub}/.well-known/afterward.json",
        "verify_engine": "https://velaru.xyz/verify",
        "demo_hop": f"{pub}/demo/hop",
        "demo_act": f"{pub}/demo/act",
        "demo_pas": f"{pub}/demo/pas/bind-check",
        "ocsp": f"{pub}/v1/fuse/lookup",
        "act": f"{pub}/v1/act",
        "pas_bind": f"{pub}/v1/pas/bind-check",
        "policycenter_pre_bind": f"{pub}/v1/pas/policycenter/pre-bind",
        "mga_authority": f"{pub}/v1/pas/mga-authority",
        "mcp": f"{pub}/mcp",
        "mcp_discovery": f"{pub}/.well-known/mcp.json",
        "x402": f"{pub}/.well-known/x402.json",
        "listings": f"{pub}/.well-known/listings.json",
        "counterfactual_spend": f"{pub}/.well-known/counterfactual-spend.json",
        "kappa_register": f"{pub}/.well-known/kappa.json",
        "schism": f"{pub}/.well-known/schism.json",
        "possibility_finality": f"{pub}/.well-known/possibility-finality.json",
        ...
        "commit_auth": f"{pub}/.well-known/commit-auth.json",
        "spend_protocol": f"{pub}/.well-known/spend-protocol.json",
        "command_radiation": f"{pub}/.well-known/command-radiation.json",
        "license_fuse": f"{pub}/.well-known/license-fuse.json",
        "restraint": f"{pub}/.well-known/restraint.json",
        "exclusion": f"{pub}/.well-known/exclusion.json?job_id={{job_id}}",
        "evidence_consistency": f"{pub}/.well-known/evidence-consistency.json?old_size={{n}}",
        "bind_ticket_redeem": f"{pub}/v1/pas/bind-ticket/redeem",
