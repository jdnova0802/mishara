...
def listings_manifest(public_url: str, contact_email: str) -> dict:
    ...
    return {
        ...
        "skip_remaining": {
            ...
            "srt": f"{public_url}/.well-known/srt.json",
            "srt_present": f"{public_url}/v1/skip/srt",
            "act_idempotency": f"{public_url}/.well-known/act/{{fingerprint}}.json",
            "mortmain_charge": f"{public_url}/v1/skip/mortmain/charge",
        ...
        "civilizational_kind": {
            ...
            "srt_seed": f"{public_url}/.well-known/srt.json",
            "their_production": False,
            "not_outbound": True,
