...
**DO NOT RE-INVENT QUARK.md as a fourth clock or as P11.** Q1–Q9 are tiny remaining with civilizational blast (vial · silent bit · fail-open default · unit-binding · zombie DOI · era-field · nonce · SRM date · recycled ticker). Q6 is field-width remaining, cousin of A11, not PNT. Hunt **open**. No `/quark` page.
...
**QUARK (name-only).** `gate/QUARK.md` — Q1–Q9. Tiny remaining, civilizational blast. The world will not see it coming. Hunt open. Not a fourth clock. No pages.
...
| `gate/QUARK.md` | **Quark shelf** — Q1–Q9 tiny remaining, civilizational blast. Hunt open. Not a fourth clock. No pages. |
