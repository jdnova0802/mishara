...
**ALARMING (name-only).** `gate/ALARMING.md` — A1 Buffer · A2 Continuous Reserve · A3 Bond-at-Transfer (Ρ) · **A4 Continuous UTC** · **A5 Lunar Timescale** · **A6 Continuing Supervision** (SPACE legal face) · **A7 Plume Stewardship** (Ρ). TraCSS folds into SPACE. DSN/GaiaNIR = BULGE. KSK + ZK waste = dead. Signed-and-gone folds into EXTERNAL E5. Coil/ship = BULGE rulers. Do not re-invent. No pages.
