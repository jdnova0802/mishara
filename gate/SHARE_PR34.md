...
**DO NOT RE-INVENT QUARK.md as a fourth clock or as P11.** Q1–Q31 are tiny remaining with civilizational blast. Q26–Q31 are the **emergency cut** (WEA shortened ID · beacon Hex · MMSI · VTEC ETN · boil-water flag · 911 LoST URI). Not earth-evacuation hopium. Q6 is field-width remaining, cousin of A11, not PNT. Cash gravity is shape, not REST — do not mint bands. Hunt **open**. No `/quark` page.
