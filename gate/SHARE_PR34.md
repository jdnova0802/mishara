...
**DO NOT RE-INVENT ENVELOPE.md as A29 or a climate SKU.** G₀ is remaining of the **given** (planetary envelope still that envelope). H₀ assumes the field. Seven of nine boundaries breached (PHC 2025). Not who-may-dim (A20). Not plastics (A21). Never sell planetary capacity. No `/envelope` page.
...
**ENVELOPE (name-only).** `gate/ENVELOPE.md` — G₀ remaining of the given. Seven of nine planetary boundaries breached. Prior to H₀. Not A29. No pages.
...
| `gate/ENVELOPE.md` | **Envelope** — G₀ remaining of the given. Prior to H₀. Not A29. No pages. |
