...
**DO NOT RE-INVENT QUARK.md as a fourth clock or as P11.** Q1–Q25 are tiny remaining with civilizational blast (vial · silent bit · fail-open · unit-binding · zombie DOI · era-field · nonce · SRM date · ticker · NDC · decimal · confRev · leftover flag · clockClass · homoglyph · truncated CRC · recycled number · unlearn · SSI · status bit · ghost vector · redaction · DSCSA serial · UDI · IMEI). Q6 is field-width remaining, cousin of A11, not PNT. Q17–Q25 cash gravity is shape, not REST — do not mint bands. Hunt **open**. No `/quark` page.
**DO NOT RE-INVENT STET.md as P11 or Q26.** S1–S8 are remaining with **no ticket** (monthly initial · calibration sticker · log of nothing · guard tour · bin · records box · unused spare · bolt preload). More boring than boring work. Let it stand. Hunt **open**. No `/stet` page.
...
**QUARK (name-only).** `gate/QUARK.md` — Q1–Q25. Tiny remaining, civilizational blast. Q17–Q25 cash gravity is shape, not REST. The world will not see it coming. Hunt open. Not a fourth clock. No pages.
...
| `gate/QUARK.md` | **Quark shelf** — Q1–Q25 tiny remaining, civilizational blast. Q17–Q25 cash gravity is shape, not REST. Hunt open. Not a fourth clock. No pages. |
