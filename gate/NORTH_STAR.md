# Gate — long-term north star

**Brand word:** Gate  
**Footnote expansion:** Governed Act Termination Engine (see `SCIENCE.md`)  
...
| Matter / kinetic | Launch, release, impact, robot force |
| Spectrum / EM | Jam, dazzle, directed energy |
| Orbital / Δv | Burn, debris-making maneuver |
...
| Phase | Job |
|-------|-----|
| **Before** | Clear or DENY — no silent LIVE |
| **During** | Inhibit mid-sequence (jam, cascade, tool-chain, burn, dose) |
| **After** | Stranger-verifiable receipt — what was allowed, denied, or never happened |

Most vendors only ship a weak **before**. **During** and **prove-after** are the scarce layers.
...
## Offense and defense (same mouth)
...
| **Invisible Staple Scale** | **Full invisible diet** — `gate/INVISIBLE_SCALE.md` — score 10 Bone Law → score 0 Act Serial / Refuse Line (chicken broccoli rice) |

**Stack (own the floor above may):** L0 can (not ours) · L1 sight (not ours) · **L2 Gate may** · **L3 Mandate** · **Bone Law** · **CBR staples** — claim upstairs *now* so peelable may cannot Foundry you.
...
## Extreme pains the world misnames (signal, not roadmap spam)

| Pain | They call it | It actually is |
|------|--------------|----------------|
| Agent spends “authorized but wrong” | Commerce UX | Missing mandate→LIVE→receipt |
| Autonomy under jam/spoof | Autonomy policy | During-inhibit + fail-closed |
| False trip cascades | Protection engineering | Undo-cost-blind fail-open |
...
## Machine / human pointers

- PRI + first weld: `SCIENCE.md`, `GET /.well-known/science-pri.json`, `/science`  
- Commercial foothold: `/bind-room`, officer pack, PAS pre-bind demos  
- Expansion footnote only: Governed Act Termination Engine  
